...
(define env-test
  (test-suite
   "Tests dla interpretera WHILE"
   (test-case "10!"
              (check-equal? (factorial 10) 3628800))
   (test-case "100 wyraz ciągu Fibonacciego"
              (check-equal? (fib-using-WHILE 100) 354224848179261915075))
   (test-case "Najmniejsza liczba pierwsza większa od 100"
              (check-equal? (find-prime-using-WHILE 100) 101))
   (test-case "Najmniejsza liczba pierwsza większa od 5000"
              (check-equal? (find-prime-using-WHILE 5000) 5003))))
(run-tests env-test)
